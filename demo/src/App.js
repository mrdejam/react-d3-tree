...
const countNodes = (count = 0, n) => {
  ...
  // Keep traversing subs while updating `count` until we reach the base case.
  return n.subs.reduce((sum, child) => countNodes(sum, child), count);
};
...
class App extends Component {
  ...
  addChildNode = () => {
    ...
    const target = data[0].subs ? data[0].subs : data[0]._subs;
