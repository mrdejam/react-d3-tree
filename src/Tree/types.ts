...
export interface TreeProps {
   ...
   * are recursively defined in the `subs` key.
   *
  ...
  /**
   * Allows for additional className(s) to be passed to all branch nodes (nodes with subs).
   *
  ...
  /**
   * Allows for additional className(s) to be passed to all leaf nodes (nodes without subs).
   *
